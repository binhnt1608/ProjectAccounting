...
namespace FinalProject.Data.Migrations
{
    ...
    partial class AddInventory_PurchaseOrder_ReservationPurchaseOrderInventory
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("FinalProject.Models.ReservationPurchaseOrderInventory", b =>
                {
                    b.Property<int>("PurchaseOrderID");

                    b.Property<int>("InventoryID");

                    b.HasKey("PurchaseOrderID", "InventoryID");

                    b.HasIndex("InventoryID");

                    b.HasIndex("PurchaseOrderID");

                    b.ToTable("ReservationPurchaseOrderInventorys");
                });
            ...
            modelBuilder.Entity("FinalProject.Models.ReservationPurchaseOrderInventory", b =>
                {
                    b.HasOne("FinalProject.Models.Inventory", "Inventory")
                        .WithMany("ReservationPurchaseOrderInventorys")
                        .HasForeignKey("InventoryID")
                        .OnDelete(DeleteBehavior.Cascade);
