...
namespace FinalProject.Controllers
{
    public class CashAccountsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CashAccountID,AccountDescription,BankAccountNumber,BankName")] CashAccount cashAccount)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CashAccountID,AccountDescription,BankAccountNumber,BankName")] CashAccount cashAccount)
        {
